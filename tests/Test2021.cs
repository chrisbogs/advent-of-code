...
namespace Tests
{
    public class Test2021
    {
        ...
        public async Task Day1()
        {
            ...
            Assert.Equal("1446", await sut.Router(2021, 1, 1));
            ...
            Assert.Equal("1486", await sut.Router(2021, 1, 2));
        }
        ...
        "forward 2" }));
            ...
            Assert.Equal("2187380", await sut.Router(2021, 2, 1));
            Assert.Equal("2086357770", await sut.Router(2021, 2, 2));
        }
        ...
        {
            var sut = new YearController(new InputRetriever());
            Assert.Equal("2648450", await sut.Router(2021, 3, 1));
            Assert.Equal("2845944", await sut.Router(2021, 3, 2));
        }
        ...
        public async Task Day4()
        {
            ...
            var sut = new YearController(new InputRetriever());
            Assert.Equal("71708", await sut.Router(2021, 4, 1));
            Assert.Equal("34726", await sut.Router(2021, 4, 2));
        }
        ...
        //    var sut = new YearController(new InputRetriever());
        //    Assert.Equal("7674", await sut.Router(2021, 5, 1));
        //    Assert.Equal("20898", await sut.Router(2021, 5, 2));
        //}
        ...
        public async Task Day6()
        {
            ...
            var sut = new YearController(new InputRetriever());
            Assert.Equal("356190", await sut.Router(2021, 6, 1));
            Assert.Equal("1617359101538", await sut.Router(2021, 6, 2));
        }
        ...
        public async Task Day7()
        {
            ...
            var sut = new YearController(new InputRetriever());
            Assert.Equal("323647", await sut.Router(2021, 7, 1));
            Assert.Equal("87640209", await sut.Router(2021, 7, 2));
        }
        ...
        public async Task Day8Part2(string[] input, string expected)
        {
            Assert.Equal(expected, TwentyTwentyOne.Day8Part2(input));
        }

        [Fact]
        public async Task Day8DetermineSegments()
        {
...
"acedgfb", "cdfbe", "gcdfa", "fbcad", "dab", "cefabd", "cdfgeb", "eafb", "cagedb", "ab"});
        ...
        {
            var sut = new YearController(new InputRetriever());
            Assert.Equal("330", await sut.Router(2021, 8, 1));
            Assert.Equal("1010472", await sut.Router(2021, 8, 2));
        }
        ...
        public async Task Day9()
        {
            ...
            var sut = new YearController(new InputRetriever());
            Assert.Equal("548", await sut.Router(2021, 9, 1));
            Assert.Equal("786048", await sut.Router(2021, 9, 2));
        }
        [Fact]
        public async Task Day9FindBasins()
        {
        ...
        {
            var sut = new YearController(new InputRetriever());
            Assert.Equal("268845", await sut.Router(2021, 10, 1));
            Assert.Equal("4038824534", await sut.Router(2021, 10, 2));
        }
        [Fact]
        ...
        [InlineData("[<>({}){}[([])<>]]")]
        [InlineData("(((((((((())))))))))")]
        public async Task TestValidParsings(string input)
        {
        ...
        [InlineData("{<[[]]>}<{[{[{[]{()[[[]", "]]}}]}]}>")]
        [InlineData("<{([{{}}[<[[[<>{}]]]>[]]", "])}>")]
        public async Task TestInvalidParsings(string input, string expected)
        {
